...
COMMANDS_META = [
    ...
    # ── 자동매매 ──
    {
        "name": "골든크로스",
        "aliases": ["gdcrs"],
        "usage": "/골든크로스 add|list|remove|intv|clear",
        "desc": "골든크로스 자동매수 설정",
        "category": "자동매매",
    },
    {
        ...
        "aliases": ["ddcrs"],
        "usage": "/데드크로스",
        "desc": "데드크로스 자동매도 (골든크로스 분봉 공유)",
        "category": "자동매매",
    },
    {
        "name": "트레일링",
        "aliases": ["trst"],
        "usage": "/트레일링 [{하락율} {최소수익률}]",
        "desc": "트레일링 스탑 설정",
        "category": "자동매매",
    },
    {
        "name": "돌파매수",
        "aliases": ["brk"],
        "usage": "/돌파매수 rate|add|list|remove",
        "desc": "돌파매수 감시 설정",
        "category": "자동매매",
    },
    {
        "name": "분할매매",
        "aliases": ["wave"],
        "usage": "/분할매매 set|view|add|list|remove",
        "desc": "분할매매 설정",
        "category": "자동매매",
    },
    {
