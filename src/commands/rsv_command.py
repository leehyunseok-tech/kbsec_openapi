...
def handle_rsv(args):
    ...
    사용법:
      /rsv {시간} {명령어}          - 매일 평일 실행 예약
      /rsv once {시간} {명령어}     - 한 번만 실행 예약
      /rsv list                     - 예약 목록 조회
      /rsv remove {일련번호}         - 특정 예약 삭제
      /rsv remove all               - 모든 예약 삭제
    """
    if not args:
        return """📅 예약 명령어 (rsv)
...
예제:
/rsv 10:00 buy 005930 5       - 매일 10:00에 삼성전자 5주 매수
/rsv once 15:30 sell 005930 5 - 오늘 15:30에만 삼성전자 5주 매도
